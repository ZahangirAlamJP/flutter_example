...
static const String id = "updateComplate";


  @override
  State<UpdateCompleteProductScreen> createState() => _AddProductScreenState();
}

class _AddProductScreenState extends State<UpdateCompleteProductScreen> {
      ...
      child: Container(
        child: Center(
          child: Padding(
            ...
            child: Column(
              children: [
               const Text("UPDATE CHOOSEN PRODUCT",
